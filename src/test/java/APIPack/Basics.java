...
import APIData.ReUsableMethods;
import APIData.payload;
import APIData.ReUsableMethods;
import APIData.payload;
...
public class Basics {
    ...
    public static void main(String[] args) {
        ...
        //given - all input details e.g. keys, header, body etc.
        //when - Submit the API -resource,http method
        //Then - validate the response comes as status-code, body scope, header
